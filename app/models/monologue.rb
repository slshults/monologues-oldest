class Monologue < ActiveRecord::Base
  ...
  validates_length_of :bodylink, :maximum=>255, :allow_nil => true
  validates_length_of :pdflink, :maximum=>255, :allow_nil => true


  attr_accessible :play_id, :location, :first_line, :body, :gender_id, :character, :style, :bodylink, :pdflink
end
